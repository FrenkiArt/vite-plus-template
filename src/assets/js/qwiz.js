...
class QwizSlider {
  constructor(selector, options = {}) {
    ...
    const animationDurationAttr = this.form.getAttribute("data-animation-duration");
     ...
     */
    this.options = {
      animationDuration: animationDurationAttr ? parseInt(animationDurationAttr) : 300,
      firstActiveSlide: 1,
      autoFocus: true,
  ...
  _updateButtons() {
    ...
    prevButtons.forEach((btn) => {
      btn.disabled = this.currentSlideIndex <= this.options.firstActiveSlide - 1;
    });
